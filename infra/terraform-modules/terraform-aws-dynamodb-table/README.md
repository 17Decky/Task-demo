...
This Terraform Module is a fork from official [Terraform AWS DynamoDB Table](https://github.com/terraform-aws-modules/terraform-aws-dynamodb-table) on v4.2.0.
